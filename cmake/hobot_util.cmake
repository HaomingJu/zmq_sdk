...
MACRO(INIT_DEPENDENCY_INFO)
  ...
  if ((${architecture} STREQUAL "default")
    ...
    set(dep_file "${CMAKE_CURRENT_SOURCE_DIR}/dep_${platform}.tmp")
      ...
      if(${vendor} STREQUAL "default")
          set(dep_file "${CMAKE_CURRENT_SOURCE_DIR}/dep_${platform}_${architecture}.tmp")
      else()
          set(dep_file "${CMAKE_CURRENT_SOURCE_DIR}/dep_${platform}_${architecture}_${vendor}.tmp")
      endif()
  endif ()
  ...
  if(${vendor} STREQUAL "default")
      ...
      set(ALGOJSON_DEPS "${CMAKE_CURRENT_SOURCE_DIR}/output_${_PLATFORM}_${_ARCHITECTURE}/etc/")
  else()
      set(_INSTALL_DIR "${CMAKE_CURRENT_SOURCE_DIR}/output_${_PLATFORM}_${_ARCHITECTURE}_${_VENDOR}/")
      set(LIB_DEPS "${CMAKE_CURRENT_SOURCE_DIR}/output_${_PLATFORM}_${_ARCHITECTURE}_${_VENDOR}/lib/")
      set(MODEL_DEPS "${CMAKE_CURRENT_SOURCE_DIR}/output_${_PLATFORM}_${_ARCHITECTURE}_${_VENDOR}/etc/models/")
      set(RES_DEPS "${CMAKE_CURRENT_SOURCE_DIR}/output_${_PLATFORM}_${_ARCHITECTURE}_${_VENDOR}/etc/res/")
      set(DATA_DEPS "${CMAKE_CURRENT_SOURCE_DIR}/output_${_PLATFORM}_${_ARCHITECTURE}_${_VENDOR}/data/")
      set(ALGOJSON_DEPS "${CMAKE_CURRENT_SOURCE_DIR}/output_${_PLATFORM}_${_ARCHITECTURE}_${_VENDOR}/etc/")
  endif()
...
add_custom_target(copy
    ...
    COMMAND ${GRADLE_CMD} --daemon copyAlgoSDKJson -Pdest=${ALGOJSON_DEPS}
    COMMAND ${GRADLE_CMD} --daemon copyAlgoSDKModels -Pdest=${MODEL_DEPS}
    WORKING_DIRECTORY ${CMAKE_CURRENT_SOURCE_DIR})
